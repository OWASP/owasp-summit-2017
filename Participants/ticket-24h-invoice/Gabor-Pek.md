...
status          : empty
regonline       : No
working-sessions: GDPR and DPO AppSec implications, Security Guild vs Security Champions, Growing the AppSec Industry, Juice Shop, Creating AppSec Talent (next 100k professionals), Define Agile Security Practices, Agile Practices for Security Teams, Teaching Attacker perspective to Developers, A10 - Underprotected APIs, Threat Modeling Cheat Sheet & Lightweight Threat Modeling, Hands on Threat Modeling Juice Shop (Deployment & Operations),
