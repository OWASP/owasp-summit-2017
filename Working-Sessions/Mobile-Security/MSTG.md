...
High-level testing methodology, including scoping, test setup and reporting. Basic technical processes such as setting up a web proxy, API monitoring using existing tools, etc.

Participants can help in the following ways:

- Describe the high-level, non-technical testing methodology. We don't have any content in this area yet!
- Write about basic, technical security testing processes on iOS. The iOS part is currently lagging behind the Android part
...
As preparation for the workshop, open tasks were converted into issues and organised as a [GitHub project](https://github.com/OWASP/owasp-mstg/projects/1). Thanks again to Romuald for taking the initiative. This project will be the basis for our ongoing work, but also for the OWASP Summit.

To be able to schedule work during the summit and create working groups we need to know who will attend the OWASP Summit and how much time you can give to the mobile workshop. Please [add yourself as a participant](https://github.com/OWASP/owasp-summit-2017/blob/master/Working-Sessions/Mobile-Security/MSTG.md) and reach out directly to Sven via Slack, [see here](https://github.com/OWASP/owasp-mstg#contributions-feature-requests-and-feedback) how to contact us via Slack.

If you do not have time during the summit but would like to help, you can start immediately by assigning issues to yourself and creating pull requests. We can potentially loop you in remotely during the summit.

## Outcome

Our ambitious goal is to complete the mobile security testing guide. To achieve this, we'll need to *at least* close the 126 "missing content" tickets listed on the [project dashboard](https://github.com/OWASP/owasp-mstg/projects/1) and produce an estimated 200 book-sized pages of content. This sounds like a lot, however, if we can gather ten people for this working session, this amounts to four pages of content per person/day which is achievable. 
