...
This Track focuses on mobile application security. It is organized by the project leaders of the [OWASP Mobile Security Testing Guide](https://www.owasp.org/index.php/OWASP_Mobile_Security_Testing_Guide) project.
...
In this project, we focus on developing two key documents: A *security standard* for mobile apps, and a *testing guide* that augments the requirements in the security standard detailed, OS-specific test cases and secure coding recommendations. 
...
The MSTG is comprehensive guide for iOS and Android mobile security testers.
</td></tr>
</table>
